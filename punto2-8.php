...
$pagina1->insertarCuerpo(' página 1');
$pagina1->insertarCuerpo(' página 2');
$pagina1->insertarCuerpo(' página 3');
$pagina1->insertarCuerpo(' página 4');
$pagina1->insertarCuerpo(' página 5');
$pagina1->insertarCuerpo(' página 6');
$pagina1->insertarCuerpo(' página 7');
$pagina1->insertarCuerpo(' página 8');
$pagina1->insertarCuerpo(' página 9');
$pagina1->graficar();
?>
</body>
</html>